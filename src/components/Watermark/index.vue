...
export default {
  ...
  methods: {
    getstatusBarHeight() {
      ...
      var screenArea = parseInt(
        SystemInfo.screenHeight * (SystemInfo.screenWidth * 1.2)
      )
      var watermarkArea = 0
